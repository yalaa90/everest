...
var PrescriptionComponent = (function () {
    function PrescriptionComponent() {
        this.prescription.count = 1;
        this.prescription.dosage = "ayklam";
        this.prescription.id = "id1";
        this.prescription.medicineName = "name";
        this.prescriptions.fill(this.prescription);
    }
