...
var clinic_service_1 = require('./clinic.service');
var FormScreen_component_1 = require('../../screens/FormScreen.component');
var ClinicComponent = (function (_super) {
    __extends(ClinicComponent, _super);
    function ClinicComponent(_clinicService) {
        _super.call(this, _clinicService);
