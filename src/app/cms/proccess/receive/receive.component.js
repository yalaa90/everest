...
var ReceiveComponent = (function (_super) {
    __extends(ReceiveComponent, _super);
    function ReceiveComponent(_receiveService) {
        _super.call(this, _receiveService);
        this._receiveService = _receiveService;
        this.note = '';
